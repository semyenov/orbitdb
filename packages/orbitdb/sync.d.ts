...
interface SyncOptions<T, A extends AccessControllerType> {
  ipfs: IPFS;
  log: LogInstance<T, A>;
  events?: SyncEvents<T>;
  start?: boolean;
...
declare function Sync<T, A extends AccessControllerType>(options: SyncOptions<T, A>): Promise<SyncInstance<T>>;
